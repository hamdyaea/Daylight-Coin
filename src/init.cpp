 ...
 * between daylightd, and daylight-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/DLT/DLT>";
    const std::string URL_WEBSITE = "<https://daylightdaylight.org>";
...
/** Sanity checks
 *  Ensure that Daylight is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Daylight process is using the data directory.
