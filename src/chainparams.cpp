...
public:
    CMainParams() {
        ...
        nDefaultPort = 8338; // different port than Daylight
        ...
        vSeeds.emplace_back("eu-dnsseed.daylightdaylight-official.org", true);
        vSeeds.emplace_back("dnsseed.daylightdaylight.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("eu-test-dnsseed.daylightdaylight-official.org", true);
        vSeeds.emplace_back("test-dnsseed.daylightdaylight.org", true);
...
class DaylightAddressChainParam : public CMainParams
{
public:
    DaylightAddressChainParam()
    {
...
static DaylightAddressChainParam chainParamsForAddressConversion;
...
const CChainParams &DaylightAddressFormatParams()
{
