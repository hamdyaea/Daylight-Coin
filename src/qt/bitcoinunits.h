...
/** Daylight unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DaylightUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DaylightUnits(QObject *parent);

    /** Daylight units.
     *  Daylight units (Daylight Gold unit work the same as Bitoin).
     *  @note Source: https://en.daylight.it/wiki/Units . 
...
typedef DaylightUnits::Unit DaylightUnit;
