...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the DaylightTestFramework
    pass

class ExampleTest(DaylightTestFramework):
    # Each functional test is a subclass of the DaylightTestFramework class.
    ...
    def custom_method(self):
        ...
        DaylightTestFramework class so other tests can use it."""
