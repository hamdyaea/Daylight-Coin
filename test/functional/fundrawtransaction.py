...
from test_framework.test_framework import DaylightTestFramework, BITCOIND_PROC_WAIT_TIMEOUT
...
class RawTransactionsTest(DaylightTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_jsonrpc(-5, "changeAddress must be a valid daylight address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        self.daylightd_processes[1].wait(timeout=BITCOIND_PROC_WAIT_TIMEOUT)
