...
class BIP66Test(DaylightTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # daylightd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and daylightd produces more specific reject
            # reasons.
