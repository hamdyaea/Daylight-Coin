...
This document provides guidelines for internationalization of the Daylight Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `daylight_en.ts` remains unchanged.
