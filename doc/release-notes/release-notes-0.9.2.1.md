Daylight Core version 0.9.2.1 is now available from:

  https://daylight.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 DLT to 0.01 DLT
...
- Fix "Start daylight on system login"
