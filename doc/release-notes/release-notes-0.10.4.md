Daylight Core version 0.10.4 is now available from:

  <https://daylight.org/bin/daylight-core-0.10.4/>
...
- #6953 `43c2789` Split daylight-tx into its own package
- #6953 `dfe0d4d` Include daylight-tx binary on Debian/Ubuntu
