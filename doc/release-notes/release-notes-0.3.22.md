Download URL: https://sourceforge.net/projects/daylight/files/Daylight/daylight-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 DLT fee schedule (users still pay 0.01 DLT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #daylight00 - #daylight99
