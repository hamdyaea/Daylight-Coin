Daylight Core version 0.9.4 is now available from:

  https://daylight.org/bin/0.9.4/
...
this update is incompatible with the Daylight system and could lead to consensus
forks.

Daylight Core released binaries from https://daylight.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~daylight/+archive/ubuntu/daylight
- A third-party or self-compiled Daylight Core

upgrade to Daylight Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
