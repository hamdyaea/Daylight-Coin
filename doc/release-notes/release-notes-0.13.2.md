Daylight Core version 0.13.2 is now available from:

  <https://daylight.org/bin/daylight-core-0.13.2/>
...
- #8908 `4a974b2` Update daylight-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow daylight-tx to create v2 transactions (btcdrak)
