Daylight-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/daylight/files/Daylight/daylight-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Daylight
...
New/changed settings (command-line or daylight.conf file)
--------------------------------------------------------
