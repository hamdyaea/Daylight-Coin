Daylight version 0.5.4 is now available for download at:
http://sourceforge.net/projects/daylight/files/Daylight/daylight-0.5.4/
...
http://gitorious.org/daylight/daylightd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Daylight-Qt notifications under Growl 1.3.
Increase required age of Daylight-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxDaylight properly when installing Daylight-Qt over it. (Windows)
