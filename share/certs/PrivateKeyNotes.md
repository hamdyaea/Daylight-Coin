...
unlocked to sign the Daylight-Qt.app bundle.
...
allowing somebody to distribute a Daylight-Qt.app or daylight-qt-setup.exe with a valid
...
that the daylight-qt.exe file inside the installer had not been tampered with.
